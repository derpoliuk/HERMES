...
from lavis.datasets.datasets.activitynet_vqa_datasets import (
    ActivityNetVQADataset,
    ActivityNetVQAEvalDataset,
)
from lavis.datasets.datasets.moviechat_vqa_datasets import (
    MovieChatVQADataset,
    MovieChatVQAEvalDataset,
)
from lavis.datasets.datasets.msrvtt_vqa_datasets import (
    MSRVTTVQADataset,
    MSRVTTVQAEvalDataset,
)
...
@registry.register_builder("moviechat_qa")
class MovieChatQABuilder(VideoQABuilder):
    train_dataset_cls = MovieChatVQADataset
    eval_dataset_cls = MovieChatVQAEvalDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/moviechat/defaults_qa.yaml",
    }
    ...
    def build(self):
        ...
        for split in ann_info.keys():
            ...
            datasets[split] = dataset_cls(
                ...
                vis_root=vis_path,
                num_frames=self.config.num_frames,
                trail_percentage=self.config.trail_percentage,
                prompt=prompt,
            )
